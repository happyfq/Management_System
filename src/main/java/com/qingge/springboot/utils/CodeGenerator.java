    ...
    private static void generate() {
        FastAutoGenerator.create("jdbc:mysql://localhost:3306/qing?serveTimezone=GMT%2b8", "root", "1234")
                .globalConfig(builder -> {
                    builder.author("Fangqi") // 设置作者
                            .enableSwagger() // 开启 swagger 模式
                            .fileOverride() // 覆盖已生成文件
                            .outputDir("D:\\小白做毕设2022\\springboot\\src\\main\\java\\"); // 指定输出目录
                })
                .packageConfig(builder -> {
                    builder.parent("com.qingge.springboot") // 设置父包名
                            .moduleName(null) // 设置父包模块名
                            .pathInfo(Collections.singletonMap(OutputFile.mapperXml, "D:\\小白做毕设2022\\springboot\\src\\main\\resources\\mapper\\")); // 设置mapperXml生成路径
                })
